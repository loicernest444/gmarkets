...
@endif
<!-- Top Bar -->
<div class="top-navbar text-white border-bottom border-soft-secondary z-1035 bg-dark">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col">
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                    @if(get_setting('show_language_switcher') == 'on')
                    <li class="list-inline-item dropdown mr-3 fs-16 " id="lang-change">
                        @php
                    ...
                    <li class="list-inline-item dropdown ml-auto ml-lg-0 mr-0 fs-16" id="currency-change">
                        @php
...
<!-- END Top Bar -->
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 text-white navbar-dark bg-white">
    <div class="position-relative logo-bar-area z-1">
        <div class="container">
            <div class="d-flex align-items-center">
                        ...
                        <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="input-group" style="display: inline-flex;">
                                    <input type="text" class="border border-warning form-control " id="search" style="border-radius: 100px;" name="keyword" @isset($query)
                                        value="{{ $query }}"
                                    @endisset placeholder="{{translate('What are you looking for...')}}" autocomplete="off">
                                    <div class="input-group-append d-none d-lg-block">
                                        
                                        <button class="btn btn-warning rounded-left" type="submit" style="border-radius: 100px;margin-left:-32px;width:150px;border-radius-left:12px">
                                            <i class="la la-search la-flip-horizontal fs-18"></i><b>{{ translate('  Search')}}</b>
                                        </button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <div class="typed-search-box stop-propagation document-click-d-none d-none bg-white shadow-lg position-absolute left-0 top-100 w-100" style="min-height: 200px text-primary">
                ...
                <div class="d-none d-lg-none ml-3 mr-0 text-primary">
                ...
                <div class="d-none d-lg-block text-right align-self-stretch mx-4 ml-3 mr-0 text-primary" data-hover="dropdown">
                    <div class="nav-cart-box dropdown h-100" id="cart_items">
                        @include('frontend.partials.cart')
                    </div>
                </div>

                <div class=" text-right d-none d-lg-block fs-15">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center text-primary">
                    @auth
                        @if(isAdmin())
...
<!-- 
        ...
        @if(Route::currentRouteName() != 'home')
        <div class="hover-category-menu position-absolute w-100 top-100 left-0 right-0 d-none z-3 text-blue" id="hover-category-menu ">
            <div class="container">
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="bg-red   mb-2 bg-gradient-warning text-dar ">
            <div class="container">
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                    @foreach (json_decode( get_setting('header_menu_labels'), true) as $key => $value)
                    <li class="list-inline-item mr-0">
                        <a href="{{ json_decode( get_setting('header_menu_links'), true)[$key] }}" class="opacity-100 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-200 ">
                            {{ translate($value) }}
                        </a>
                    </li>
                    @endforeach
