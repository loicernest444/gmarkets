...
@section('content')
    ...
    <div class="home-banner-area mb-4 pt-3">
        <div class="container">
            <div class="row gutters-10 position-relative bg-white" style="padding: 0.5rem">
                ...
                <div class="col-lg-2 order-3 mt-3 mt-lg-0">
                    <div class="bg-white rounded shadow-sm">
                        <div class="bg-soft-warning rounded-top p-3 d-flex align-items-center justify-content-center">
                        ...
                        <div class="c-scrollbar-light overflow-auto h-lg-400px p-2 bg-white rounded-bottom">
                            ...
                            @foreach (filter_products(\App\Product::where('published', 1)->where('todays_deal', '1'))->get() as $key => $product)
                                @if ($product != null)
                                <div class="col mb-2">
                                    <a href="{{ route('product', $product->slug) }}" class="d-block p-2 text-reset bg-white h-100 rounded border-bottom">
